...
from symdata.bbox import bbox_overlaps
...
class Cityscape(IMDB):
    ...
    def _load_gt_roidb(self):
        return self.load_cityscape_annotations()
    ...
    def load_cityscape_annotations(self):
        ...
        assert len(imgfiles_list) == len(self.image_set_index), 'number of boxes matrix must match number of images'
        roidb = []
    ...
    def _evaluate_detections(self, detections):
